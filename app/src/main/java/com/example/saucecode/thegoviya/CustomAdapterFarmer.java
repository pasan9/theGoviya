...
public class CustomAdapterFarmer extends ArrayAdapter<Products> implements View.OnClickListener{
    ...
    public CustomAdapterFarmer(ArrayList<Products> data, Context context) {
        super(context, R.layout.row_item_user_products, data);
        this.dataSet = data;
...
*/
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CustomAdapterFarmer.ViewHolder viewHolder; // view lookup cache stored in tag
        ...
        if (convertView == null) {
            ...
            viewHolder = new CustomAdapterFarmer.ViewHolder();
            ...
            viewHolder = (CustomAdapterFarmer.ViewHolder) convertView.getTag();
            result=convertView;
        }
